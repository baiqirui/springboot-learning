package com.mealkey.core.data.service;
...
import com.mealkey.core.data.mapper.MealtimeBaseMapper;
import com.mealkey.core.data.model.BaseEntity;
import com.mealkey.core.data.util.MealkeyPageHelper;
...
{
    protected abstract MealtimeBaseMapper<T> getMapper();
    ...
    {
        Page<T> page = MealkeyPageHelper.startPage(pageNum, pageSize);
    ...
    public Long getKey()
    {
        ...
        return getMapper().getKey(RandomUtils.nextInt());
    }
