...
public final class StringUtil
{
     ...
     * 餐链连接地址。
     */
    // public static final String PATH = "http://test.mealcome.cn";// 测试
    public static final String PATH = "http://mealcome.cn";// 正式

    /**
     * sessionId。
     */
    public static final String SESSIONID = "f2bf4925e2114fb0a623d403156b33aa";
